...
export default function Footer() {
  ...
  return (
    <footer className="bg-background border-t border-border pt-20 pb-10" dir={isRtl ? 'rtl' : 'ltr'}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center hover:text-primary hover:border-primary transition-colors">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">{t('footer.newsDesc')}</p>
            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
              <Input type="email" placeholder={t('footer.emailPlaceholder')} className="bg-foreground/5 border-border focus-visible:ring-primary" />
              <Button type="submit" size="icon" className="bg-primary hover:bg-primary-velvet shrink-0">
